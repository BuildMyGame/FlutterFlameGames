...
class CTRCandy extends PositionComponent {
  final Images? images;
  CTRCandy({this.images});
  ...
  FutureOr<void> onLoad() async {
    ...
    final candyBgComponent = SpriteComponent(sprite: candyBg)
      ..anchor = Anchor.topLeft
      ..position = Vector2(0, 0);
    add(candyBgComponent);

    final candyFg = await Sprite.load("obj_candy_01.png",
        images: images, srcPosition: Vector2(2, 95), srcSize: Vector2(60, 60));
    final candyFgComponent = SpriteComponent(sprite: candyFg)
      ..anchor = Anchor.center
      ..position = Vector2(37, 32);
    add(candyFgComponent);
